...
with tab2:
    ...
    sns.lineplot(data=data_merge, x="일자", y="KOSPI 200 거래량", label="KOSPI 200 거래량", ci=None)
    sns.lineplot(data=data_merge, x="일자", y="KOSPI 200 ESG 거래량", label="KOSPI 200 ESG 거래량", ci=None)
